...
5. Checkout and build [[https://github.com/0xPolygonZero/erigon][jerrigon]] from the ~feat/zero~ branch. We'll need
...
7. [@7] Run the stateless command. The snippet below and some of the
   others assume you've checked out [[https://github.com/0xPolygonZero/erigon/tree/feat/zero][jerrigon]] in ~$HOME/code/jerrigon~
